...
tax_rate = 0.38
mfuel = 1  # It should be obtained from the layout(kg/s)
annual_om = 9.839  # $/MWhe in 2023$
prod_capacity = 30  # It should be obtained from the layout (MW)

pec = list()
##Getting the Individual Purchasing Equipment Cost (PEC)
pec.append(10e6)
pec.append(20e6)
pec.append(30e6)
pec.append(40e6)
...
tcr_yearly = [
    bd_debt + adj_debt[i] + bd_equity + adj_equity[i] for i in range(len(adj_equity))
]
...
fcl_currrent = fc * celffuel
first_term = (trrl_current + fcl_currrent) / T
